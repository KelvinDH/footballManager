...
export function ResourceUpdateModal({ isOpen, onClose, moneyChange, fansChange, playerUpdates, matchStats }: ResourceUpdateModalProps) {
        ...
        >
          ...
          >
            <div className="flex justify-between items-center mb-4">
              <h2 className="text-2xl font-bold">{t('roundSummary')}</h2>
              ...
              <div className="mt-6">
                ...
                <div className="bg-gray-100 p-4 rounded-lg mb-4">
                  <div className="flex justify-between items-center mb-2">
                    ...
                    <span className="text-2xl font-bold">{matchStats.homeScore || 0} - {matchStats.awayScore || 0}</span>
