            ...
            <CardContent>
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
                {menuItems.map((item) => (
                  ...
                  >
                    <Button
                      onClick={item.action}
                      className="w-full h-24 text-lg font-semibold bg-green-600 hover:bg-green-700 transition-colors duration-300"
                    >
              ...
              <div className="flex justify-between items-center bg-green-100 p-4 rounded-lg">
                <div className="flex items-center">
                  ...
                  <span className="font-semibold">{updatedTeam.fans.toLocaleString()} {t('fans')}</span>
                </div>
                <div className="flex items-center">
                  <DollarSign className="w-6 h-6 mr-2 text-green-600" />
                  <span className="font-semibold">R$ {updatedTeam.money.toLocaleString()}</span>
                </div>
              </div>
            </CardContent>
          </Card>
